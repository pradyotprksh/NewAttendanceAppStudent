 ...
 */
public class FacultyTimetableWednesdayFragment extends Fragment {
    ...
    public FacultyTimetableWednesdayFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_faculty_timetable_wednesday, container, false);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    if (task.getResult().exists()) {
                        ...
                        mFirestore.collection("Timetable").document(task.getResult().getString("className")).collection("Wednesday").orderBy("from").addSnapshotListener(getActivity(), new EventListener<QuerySnapshot>() {
                            @Override
