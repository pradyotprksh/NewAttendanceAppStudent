 ...
 */
public class FacultyTimetableSaturdayFragment extends Fragment {
    ...
    public FacultyTimetableSaturdayFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_faculty_timetable_saturday, container, false);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    if (task.getResult().exists()) {
                        ...
                        mFirestore.collection("Timetable").document(task.getResult().getString("className")).collection("Saturday").orderBy("from").addSnapshotListener(getActivity(), new EventListener<QuerySnapshot>() {
                            @Override
